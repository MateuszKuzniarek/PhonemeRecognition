...
from src.WaveFileData import WaveFileData
from src.PhonemeData import PhonemeData
...
class DatasetExplorer:
    ...
    def get_phoneme_data(self, train_set: bool, accent_id: str, speaker_id: str, sentence_id: str) -> [PhonemeData]:
        ...
        with open(file_path, newline='') as phoneme_file:
            ...
            for line in reader:
                phoneme_series.append(PhonemeData(line[0], line[1], line[2]))
    ...
    def get_accent_ids(self, train_set: bool) -> [str]:
        ...
        return [accent_id for accent_id in os.listdir(accents_directory_path) if os.path.isdir(accent_id)]
    ...
    def get_speaker_ids(self, train_set: bool, accent_id: str) -> [str]:
        ...
        return [speaker_id for speaker_id in os.listdir(speakers_directory_path) if os.path.isdir(speaker_id)]
    ...
    def get_sentences_ids(self, train_set: bool, accent_id: str, speaker_id: str) -> [str]:
        ...
        return [sentence_id for sentence_id in os.listdir(sentences_directory_path) if not os.path.isdir(sentence_id)]
